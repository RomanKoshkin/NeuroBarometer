...
% load('/Volumes/Transcend/NeuroBarometer/EEG_latest/DAS_9may_raw.mat')
% load('/Volumes/Transcend/NeuroBarometer/EEG_latest/DAS_9may_raw_AVG.mat')
% load('/Volumes/Transcend/NeuroBarometer/EEG_latest/DAS_9may_raw_AVG_2.mat')
% load('/Volumes/Transcend/NeuroBarometer/EEG_latest/NeoRec_2018-05-08_16-52-10_-eyes+preprocENV.mat')
% load('/Volumes/Transcend/NeuroBarometer/EEG_latest/NeoRec_2018-05-08_21-47-10+ICA(-IC1,2,3,5)preproc_aud.mat')
load('/Volumes/Transcend/NeuroBarometer/EEG_latest/NeoRec_2018-05-08_21-47-10+ICA(-IC1)preproc_aud.mat')
...
if AUDIO_PREPROC == 1
    ...
    AUDIO.data(1,:) = AUDIO.data(1,:) - mean(AUDIO.data(1,:));
    AUDIO.data(2,:) = AUDIO.data(2,:) - mean(AUDIO.data(2,:));
